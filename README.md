...
Esdee is a DNS-SD discovery client for Gleam on Erlang.
It provides both selector-based and actor-based mechanisms 
to discover available service types and details.

The following example uses the `discoverer` actor
to enumerate and print all service types and service details on you local network.
...
gleam dev   # Discover all your local services
```
